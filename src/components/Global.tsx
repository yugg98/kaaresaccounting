...
import datas from "@/utils/indiandata.json";
  ...
  return (
    <div>
      <Container className="borde !px-0 sm:px-6 my-10">
        ...
        <p className="text-md font-semibold mb-2 mx-4">Global Services</p>
          ...
          <div className="md:first-line md:w-1/2">
            <p className="text-md font-semibold mb-2 mx-4">Indian Services</p>
            {datas
