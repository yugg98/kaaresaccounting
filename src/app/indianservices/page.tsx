...
const Page = () => {
  ...
  return (
    <div>
      <Container className="bord-0 !px-0 sm:px-6">
        <div className="md:mx-auto mt-8 max-w-5xl md:text-center py-12 px-4">
        ...
        <div className="flex flex-wrap bord-y">
          <div className="md:w-1/2">
            {data
              ...
              .map((e, index) => (
                <div key={index} className="p-6 md:p-8 borer-b boder-r ">
          ...
          <div className="md:first-line md:w-1/2">
            {data
              .filter((_, index) => index % 2 != 0)
              .map((e, index) => (
                <div key={index} className="p-6 md:p-8  boer-b bder-r  ">
